...
setup(
    name='topology_openswitch',
    version=find_version('lib/topology_openswitch/__init__.py'),
    package_dir={'': 'lib'},
    ...
    description=(
        'An abstract node for all the common functionality of the OpenSwitch '
        'nodes.'
    ),
    long_description=read('README.rst'),
    url='https://github.com/HPENetworking/topology_openswitch/tree/master/doc',
    keywords='topology_openswitch',
